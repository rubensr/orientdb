 ...
 * @since 8/7/13
 */
public class OSBTreeSingleValue<K> extends ODurableComponent {
  ...
  public void create(OBinarySerializer<K> keySerializer, OType[] keyTypes, int keySize, boolean nullPointerSupport,
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error during sbtree creation", this), e);
    }
    ...
    try {
      ...
      try {
        ...
        OSBTreeBucketSingleValue<K> rootBucket = new OSBTreeBucketSingleValue<>(rootCacheEntry, true, keySerializer, keyTypes,
            encryption);
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error creation of sbtree with name " + getName(), this), e);
  ...
  public ORID get(K key) {
    ...
    try {
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during retrieving  of sbtree with name " + getName(), this), e);
    } finally {
  ...
  public boolean update(K key, ORID value, OIndexEngine.Validator<K, ORID> validator) {
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error during sbtree entrie put", this), e);
    }
    ...
    try {
      ...
      rollback(e);
      throw OException.wrapException(new OSBTreeSingleValueException("Error during index update with key " + key, this), e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
    } finally {
  ...
  public void clear() {
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error during sbtree clear", this), e);
    }
    ...
    try {
      ...
      try {
        OSBTreeBucketSingleValue<K> rootBucket = new OSBTreeBucketSingleValue<>(cacheEntry, true, keySerializer, keyTypes,
            encryption);
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during clear of sbtree with name " + getName(), this), e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
    } finally {
  ...
  public void delete() {
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error during sbtree deletion", this), e);
    }
    ...
    try {
      ...
      rollback(e);
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during delete of sbtree with name " + getName(), this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public void deleteWithoutLoad() {
    ...
    try {
      ...
      rollback(e);
      throw OException.wrapException(new OSBTreeSingleValueException("Exception during deletion of sbtree " + getName(), this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public void load(String name, OBinarySerializer<K> keySerializer, OType[] keyTypes, int keySize, boolean nullPointerSupport,
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Exception during loading of sbtree " + name, this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public long size() {
    ...
    try {
      ...
      try {
        ...
        try {
          OSBTreeBucketSingleValue<K> rootBucket = new OSBTreeBucketSingleValue<>(rootCacheEntry, keySerializer, keyTypes,
              encryption);
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during retrieving of size of index " + getName(), this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }
  ...
  public ORID remove(K key) {
    ...
    try {
      ...
      throw OException.wrapException(new OSBTreeSingleValueException("Error during sbtree entrie remove", this), e);
    }
    ...
    try {
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during removing key " + key + " from sbtree " + getName(), this),
              e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
  ...
  public K firstKey() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during finding first key in sbtree [" + getName() + "]", this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }
  ...
  public K lastKey() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OSBTreeSingleValueException("Error during finding last key in sbtree [" + getName() + "]", this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }
  ...
  private void updateSize(long diffSize, OAtomicOperation atomicOperation) throws IOException {
    ...
    try {
      OSBTreeBucketSingleValue<K> rootBucket = new OSBTreeBucketSingleValue<>(rootCacheEntry, keySerializer, keyTypes, encryption);
  ...
  private BucketSearchResult splitBucket(OSBTreeBucketSingleValue<K> bucketToSplit, OCacheEntry entryToSplit, List<Long> path,
  ...
  private BucketSearchResult splitNonRootBucket(List<Long> path, int keyIndex, K keyToInsert, long pageIndex,
      OSBTreeBucketSingleValue<K> bucketToSplit, boolean splitLeaf, int indexToSplit, K separationKey, List<byte[]> rightEntries,
      OAtomicOperation atomicOperation) throws IOException {
    OCacheEntry rightBucketEntry = addPage(atomicOperation, fileId);

    try {
      OSBTreeBucketSingleValue<K> newRightBucket = new OSBTreeBucketSingleValue<>(rightBucketEntry, splitLeaf, keySerializer,
          keyTypes, encryption);
      ...
      if (splitLeaf) {
        ...
        if (rightSiblingPageIndex >= 0) {
          ...
          OSBTreeBucketSingleValue<K> rightSiblingBucket = new OSBTreeBucketSingleValue<>(rightSiblingBucketEntry, keySerializer,
              keyTypes, encryption);
          try {
      ...
      try {
        OSBTreeBucketSingleValue<K> parentBucket = new OSBTreeBucketSingleValue<>(parentCacheEntry, keySerializer, keyTypes,
            encryption);
        OSBTreeBucketSingleValue.SBTreeEntry<K> parentEntry = new OSBTreeBucketSingleValue.SBTreeEntry<>((int) pageIndex,
  ...
  private BucketSearchResult splitRootBucket(List<Long> path, int keyIndex, K keyToInsert, OCacheEntry bucketEntry,
    ...
    OCacheEntry rightBucketEntry = addPage(atomicOperation, fileId);
    try {
      OSBTreeBucketSingleValue<K> newLeftBucket = new OSBTreeBucketSingleValue<>(leftBucketEntry, splitLeaf, keySerializer,
          keyTypes, encryption);
  ...
  private BucketSearchResult findBucket(K key, OAtomicOperation atomicOperation) throws IOException {
    ...
    while (true) {
      if (path.size() > MAX_PATH_LENGTH) {
        throw new OSBTreeSingleValueException(
  ...
  public class OSBTreeFullKeyCursor implements OSBTreeKeyCursor<K> {
    ...
    public K next(int prefetchSize) {
      ...
      atomicOperationsManager.acquireReadLock(OSBTreeSingleValue.this);
      try {
        acquireSharedLock();
        try {
          OAtomicOperation atomicOperation = atomicOperationsManager.getCurrentOperation();
        ...
        throw OException
            .wrapException(new OSBTreeSingleValueException("Error during element iteration", OSBTreeSingleValue.this), e);
      } finally {
        atomicOperationsManager.releaseReadLock(OSBTreeSingleValue.this);
      }
