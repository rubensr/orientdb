 ...
 * @since 8/7/13
 */
public class OSingleValuePrefixBTree extends ODurableComponent {
  ...
  public OSingleValuePrefixBTree(String name, String dataFileExtension, String nullFileExtension,
  ...
  public void create(OBinarySerializer<String> keySerializer, boolean nullPointerSupport, OEncryption encryption) {
    assert keySerializer != null;
    final OAtomicOperation atomicOperation;
    try {
      atomicOperation = startAtomicOperation(false);
    } catch (IOException e) {
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during sbtree creation", this), e);
    }
    ...
    try {
      ...
      try {
        OSingleValuePrefixBTreeBucket rootBucket = new OSingleValuePrefixBTreeBucket(rootCacheEntry, true, keySerializer,
            encryption, "");
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error creation of sbtree with name " + getName(), this), e);
    ...
    try {
      ...
      try {
        ...
        if (key != null) {
          ...
          try {
            OSingleValuePrefixBTreeBucket keyBucket = new OSingleValuePrefixBTreeBucket(keyBucketCacheEntry, keySerializer,
                encryption);
          ...
          try {
            final OSingleValueNullBucket nullBucket = new OSingleValueNullBucket(nullBucketCacheEntry, false);
            final ORID treeValue = nullBucket.getValue();
            return treeValue;
          } finally {
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during retrieving  of sbtree with name " + getName(), this),
              e);
    } finally {
  ...
  public void put(String key, ORID value) {
    put(key, value, null);
  }

  public boolean validatedPut(String key, ORID value, OIndexEngine.Validator<String, ORID> validator) {
    return put(key, value, validator);
  }

  private boolean put(String key, ORID value, OIndexEngine.Validator<String, ORID> validator) {
    return update(key, (x, bonsayFileId) -> {
      final OIndexUpdateAction<ORID> changed = OIndexUpdateAction.changed(value);
      return changed;
    }, validator);
  }

  @SuppressWarnings("unchecked")
  public boolean update(String key, OIndexKeyUpdater<ORID> updater, OIndexEngine.Validator<String, ORID> validator) {
    final OAtomicOperation atomicOperation;
    try {
      atomicOperation = startAtomicOperation(true);
    } catch (IOException e) {
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during sbtree entrie put", this), e);
    }
    ...
    try {
      ...
      if (key != null) {
        ...
        OSingleValuePrefixBTreeBucket keyBucket = new OSingleValuePrefixBTreeBucket(keyBucketCacheEntry, keySerializer, encryption);
        ...
        if (oldRawValue == null) {
          ...
          oldValue = OCompactedLinkSerializer.INSTANCE.deserializeNativeObject(oldRawValue, 0).getIdentity();
        }

        OIndexUpdateAction<ORID> updatedValue = updater.update(oldValue, bonsayFileId);
        if (updatedValue.isChange()) {
          ORID value = updatedValue.getValue();
          ...
          final byte[] serializeValue = OCompactedLinkSerializer.INSTANCE.serializeNativeAsWhole(value);
          ...
          while (!keyBucket.addEntry(insertionIndex, new OSingleValuePrefixBTreeBucket.SBTreeEntry(-1, -1, key, value), true)) {
            ...
            if (bucketSearchResult.getLastPathItem() != keyBucketCacheEntry.getPageIndex()) {
              ...
              keyBucket = new OSingleValuePrefixBTreeBucket(keyBucketCacheEntry, keySerializer, encryption);
            }
          }
        ...
        boolean ignored = false;
        try {
          final OSingleValueNullBucket nullBucket = new OSingleValueNullBucket(cacheEntry, isNew);
      ...
      rollback(e);
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during index update with key " + key, this), e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
    } finally {
  ...
  public void clear() {
    ...
    try {
      ...
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during sbtree clear", this), e);
    }
    ...
    try {
      ...
      try {
        OSingleValuePrefixBTreeBucket rootBucket = new OSingleValuePrefixBTreeBucket(cacheEntry, true, keySerializer, encryption,
            "");
        rootBucket.setTreeSize(0);
      } finally {
        releasePageFromWrite(atomicOperation, cacheEntry);
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during clear of sbtree with name " + getName(), this), e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
    } finally {
  ...
  public void delete() {
    ...
    try {
      ...
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during sbtree deletion", this), e);
    }
    ...
    try {
      ...
      rollback(e);
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during delete of sbtree with name " + getName(), this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public void deleteWithoutLoad() {
    ...
    try {
      ...
      rollback(e);
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Exception during deletion of sbtree " + getName(), this), e);
    } finally {
      releaseExclusiveLock();
    }
  }

  public void load(String name, OBinarySerializer<String> keySerializer, boolean nullPointerSupport, OEncryption encryption) {
    acquireExclusiveLock();
    try {
      this.encryption = encryption;
      this.nullPointerSupport = nullPointerSupport;
      ...
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Exception during loading of sbtree " + name, this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public long size() {
    ...
    try {
      ...
      try {
        ...
        try {
          OSingleValuePrefixBTreeBucket rootBucket = new OSingleValuePrefixBTreeBucket(rootCacheEntry, keySerializer, encryption);
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during retrieving of size of index " + getName(), this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }

  public ORID remove(String key) {
    final OAtomicOperation atomicOperation;
    try {
      atomicOperation = startAtomicOperation(true);
    } catch (IOException e) {
      throw OException.wrapException(new OSingleValuePrefixBTreeException("Error during sbtree entrie remove", this), e);
    }
    ...
    try {
      ...
      if (key != null) {
        ...
        removedValue = OCompactedLinkSerializer.INSTANCE
      ...
      throw OException.wrapException(
          new OSingleValuePrefixBTreeException("Error during removing key " + key + " from sbtree " + getName(), this), e);
    } catch (RuntimeException e) {
      rollback(e);
      throw e;
    } finally {
  ...
  private ORID removeNullBucket(OAtomicOperation atomicOperation) throws IOException {
    ...
    try {
      OSingleValueNullBucket nullBucket = new OSingleValueNullBucket(nullCacheEntry, false);
  ...
  public OSBTreeCursor<String, ORID> iterateEntriesMinor(String key, boolean inclusive, boolean ascSortOrder) {
    atomicOperationsManager.acquireReadLock(this);
    try {
      acquireSharedLock();
      try {
  ...
  public OSBTreeCursor<String, ORID> iterateEntriesMajor(String key, boolean inclusive, boolean ascSortOrder) {
    atomicOperationsManager.acquireReadLock(this);
    try {
      acquireSharedLock();
      try {
  ...
  public String firstKey() {
    ...
    try {
      ...
      try {
        ...
        try {
          OSingleValuePrefixBTreeBucket bucket = new OSingleValuePrefixBTreeBucket(cacheEntry, keySerializer, encryption);
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during finding first key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  public String lastKey() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OSingleValuePrefixBTreeException("Error during finding last key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  public OSBTreeCursor<String, ORID> iterateEntriesBetween(String keyFrom, boolean fromInclusive, String keyTo, boolean toInclusive,
  ...
  private void checkNullSupport(String key) {
    if (key == null && !nullPointerSupport)
      throw new OSingleValuePrefixBTreeException("Null keys are not supported.", this);
  }
  ...
  private OSBTreeCursor<String, ORID> iterateEntriesMinorDesc(String key, boolean inclusive) {
    key = keySerializer.preprocess(key, OType.STRING);
    return new OSBTreeCursorBackward(null, key, false, inclusive);
  }

  private OSBTreeCursor<String, ORID> iterateEntriesMinorAsc(String key, boolean inclusive) {
    acquireSharedLock();
    try {
      key = keySerializer.preprocess(key, OType.STRING);
  ...
  private OSBTreeCursor<String, ORID> iterateEntriesMajorAsc(String key, boolean inclusive) {
    key = keySerializer.preprocess(key, OType.STRING);
    return new OSBTreeCursorForward(key, null, inclusive, false);
  }

  private OSBTreeCursor<String, ORID> iterateEntriesMajorDesc(String key, boolean inclusive) {
    key = keySerializer.preprocess(key, OType.STRING);
  ...
  private BucketSearchResult firstItem(OAtomicOperation atomicOperation) throws IOException {
    ...
    try {
      ...
      while (true) {
        if (!bucket.isLeaf()) {
          if (bucket.isEmpty() || itemIndex > bucket.size()) {
            ...
            if (itemIndex < bucket.size()) {
              ...
              OSingleValuePrefixBTreeBucket.SBTreeEntry entry = bucket.getEntry(itemIndex);
              bucketIndex = entry.leftChild;

            } else {
              path.add(new PagePathItemUnit(bucketIndex, itemIndex));

              OSingleValuePrefixBTreeBucket.SBTreeEntry entry = bucket.getEntry(itemIndex - 1);
        ...
        bucket = new OSingleValuePrefixBTreeBucket(cacheEntry, keySerializer, encryption);
      }
    } finally {
      releasePageFromRead(atomicOperation, cacheEntry);
    }
  ...
  private BucketSearchResult lastItem(OAtomicOperation atomicOperation) throws IOException {
    ...
    try {
      while (true) {
        if (!bucket.isLeaf()) {
          if (itemIndex < -1) {
            ...
            if (itemIndex > -1) {
              ...
              OSingleValuePrefixBTreeBucket.SBTreeEntry entry = bucket.getEntry(0);
              bucketIndex = entry.leftChild;
            }

            itemIndex = OSingleValuePrefixBTreeBucket.MAX_PAGE_SIZE_BYTES + 1;
          }
        } else {
          if (bucket.isEmpty()) {
            if (!path.isEmpty()) {
        ...
        bucket = new OSingleValuePrefixBTreeBucket(cacheEntry, keySerializer, encryption);
        if (itemIndex == OSingleValuePrefixBTreeBucket.MAX_PAGE_SIZE_BYTES + 1) {
  ...
  private OSBTreeCursor<String, ORID> iterateEntriesBetweenAscOrder(String keyFrom, boolean fromInclusive, String keyTo,
      boolean toInclusive) {
  ...
  private OSBTreeCursor<String, ORID> iterateEntriesBetweenDescOrder(String keyFrom, boolean fromInclusive, String keyTo,
      boolean toInclusive) {
    keyFrom = keySerializer.preprocess(keyFrom, OType.STRING);
    keyTo = keySerializer.preprocess(keyTo, OType.STRING);
  ...
  private BucketUpdateSearchResult splitBucket(OCacheEntry bucketToSplitEntry, OSingleValuePrefixBTreeBucket bucketToSplit,
      List<Long> path, List<String> leftBoundaries, List<String> rightBoundaries, int keyIndex, String keyToInsert,
    ...
    if (pageIndex != ROOT_INDEX) {
      final List<OSingleValuePrefixBTreeBucket.SBTreeEntry> rightEntries = new ArrayList<>(indexToSplit);
  ...
  private BucketUpdateSearchResult splitNonRootBucket(List<Long> path, List<String> leftBoundaries, List<String> rightBoundaries,
      int keyIndex, String keyToInsert, long pageIndex, OSingleValuePrefixBTreeBucket bucketToSplit, boolean splitLeaf,
      int indexToSplit, String separationKey, List<OSingleValuePrefixBTreeBucket.SBTreeEntry> rightEntries,
      OAtomicOperation atomicOperation) throws IOException {
    ...
    try {
      OSingleValuePrefixBTreeBucket newRightBucket = new OSingleValuePrefixBTreeBucket(rightBucketEntry, splitLeaf, keySerializer,
      ...
      try {
        OSingleValuePrefixBTreeBucket parentBucket = new OSingleValuePrefixBTreeBucket(parentCacheEntry, keySerializer, encryption);
        OSingleValuePrefixBTreeBucket.SBTreeEntry parentEntry = new OSingleValuePrefixBTreeBucket.SBTreeEntry((int) pageIndex,
        ...
        while (!parentBucket.addEntry(insertionIndex, parentEntry, true)) {
          ...
          if (parentIndex != parentCacheEntry.getPageIndex()) {
            ...
            parentBucket = new OSingleValuePrefixBTreeBucket(parentCacheEntry, keySerializer, encryption);
          }
        }
  ...
  private BucketUpdateSearchResult splitRootBucket(List<Long> path, int keyIndex, String keyToInsert, OCacheEntry bucketEntry,
      OSingleValuePrefixBTreeBucket bucketToSplit, boolean splitLeaf, int indexToSplit, String separationKey,
      List<byte[]> rightEntries, OAtomicOperation atomicOperation) throws IOException {
    ...
    OCacheEntry rightBucketEntry = addPage(atomicOperation, fileId);
    try {
      OSingleValuePrefixBTreeBucket newLeftBucket = new OSingleValuePrefixBTreeBucket(leftBucketEntry, splitLeaf, keySerializer,
          encryption, "");
    ...
    bucketToSplit = new OSingleValuePrefixBTreeBucket(bucketEntry, false, keySerializer, encryption, "");

    bucketToSplit.setTreeSize(treeSize);
    bucketToSplit.setValuesFreeListFirstIndex(freeListPage);

    bucketToSplit.addEntry(0,
        new OSingleValuePrefixBTreeBucket.SBTreeEntry((int) leftBucketEntry.getPageIndex(), (int) rightBucketEntry.getPageIndex(),
  ...
  private BucketUpdateSearchResult findBucketForUpdate(String key, OAtomicOperation atomicOperation) throws IOException {
    ...
    while (true) {
      if (path.size() > MAX_PATH_LENGTH) {
        throw new OSingleValuePrefixBTreeException(
      ...
      final OSingleValuePrefixBTreeBucket.SBTreeEntry entry;

      final int entryIndex;
      try {
        final OSingleValuePrefixBTreeBucket keyBucket = new OSingleValuePrefixBTreeBucket(bucketEntry, keySerializer, encryption);
  ...
  private Map.Entry<String, ORID> convertToMapEntry(OSingleValuePrefixBTreeBucket.SBTreeEntry treeEntry,
      OAtomicOperation atomicOperation) {
    final String key = treeEntry.key;
    final ORID value = treeEntry.value;

    return new Map.Entry<String, ORID>() {
      @Override
  ...
  public class OSBTreeFullKeyCursor implements OSBTreeKeyCursor<String> {
    ...
    public String next(int prefetchSize) {
      ...
      atomicOperationsManager.acquireReadLock(OSingleValuePrefixBTree.this);
      try {
        acquireSharedLock();
        try {
          OAtomicOperation atomicOperation = atomicOperationsManager.getCurrentOperation();
            ...
            while (keysCache.size() < prefetchSize) {
              while (itemIndex >= bucket.size()) {
                ...
                while (pathItem != null) {
                  ...
                  try {
                    final OSingleValuePrefixBTreeBucket parentBucket = new OSingleValuePrefixBTreeBucket(parentBucketCacheEntry,
                    ...
                    if (cItemIndex >= parentBucket.size()) {
                      ...
                      OSingleValuePrefixBTreeBucket.SBTreeEntry entry = parentBucket.getEntry(cItemIndex);
              ...
              final Map.Entry<String, ORID> entry = convertToMapEntry(bucket.getEntry(itemIndex), atomicOperation);
              itemIndex++;
        ...
        throw OException
            .wrapException(new OSingleValuePrefixBTreeException("Error during element iteration", OSingleValuePrefixBTree.this), e);
      } finally {
        atomicOperationsManager.releaseReadLock(OSingleValuePrefixBTree.this);
      }
  ...
  private final class OSBTreeCursorForward implements OSBTreeCursor<String, ORID> {
    private       String  fromKey;
    private final String  toKey;
    private       boolean fromKeyInclusive;
    private final boolean toKeyInclusive;

    private List<Map.Entry<String, ORID>>     dataCache         = new ArrayList<>();
    @SuppressWarnings("unchecked")
    private Iterator<Map.Entry<String, ORID>> dataCacheIterator = OEmptyMapEntryIterator.INSTANCE;
    ...
    public Map.Entry<String, ORID> next(int prefetchSize) {
      if (dataCacheIterator == null) {
        return null;
      }

      if (dataCacheIterator.hasNext()) {
        final Map.Entry<String, ORID> entry = dataCacheIterator.next();
  ...
  private final class OSBTreeCursorBackward implements OSBTreeCursor<String, ORID> {
    private final String  fromKey;
    private       String  toKey;
    private final boolean fromKeyInclusive;
    private       boolean toKeyInclusive;

    private final List<Map.Entry<String, ORID>>     dataCache         = new ArrayList<>();
    @SuppressWarnings("unchecked")
    private       Iterator<Map.Entry<String, ORID>> dataCacheIterator = OEmptyMapEntryIterator.INSTANCE;
              ...
              while (itemIndex < 0) {
                ...
                while (true) {
                  if (bucket.isLeaf()) {
                    ...
                    OSingleValuePrefixBTreeBucket.SBTreeEntry entry = bucket.getEntry(0);
                    final long childIndex = entry.rightChild;
